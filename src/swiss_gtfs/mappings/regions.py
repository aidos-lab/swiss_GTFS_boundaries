...
region_names_chl: dict[str, str] = {
    # Arica y Parinacota
    "xv": "Región de Arica y Parinacota", "arica": "Región de Arica y Parinacota", "arica_y_parinacota": "Región de Arica y Parinacota",
    # Tarapacá
    "i": "Región de Tarapacá", "tarapaca": "Región de Tarapacá",
    # Antofagasta
    "ii": "Región de Antofagasta", "antofagasta": "Región de Antofagasta",
    # Atacama
    "iii": "Región de Atacama", "atacama": "Región de Atacama",
    # Coquimbo
    "iv": "Región de Coquimbo", "coquimbo": "Región de Coquimbo",
    # Valparaíso
    "v": "Región de Valparaíso", "valparaiso": "Región de Valparaíso",
    # Metropolitana
    "rm": "Región Metropolitana de Santiago", "xiii": "Región Metropolitana de Santiago", "santiago": "Región Metropolitana de Santiago",
    # O'Higgins
    "vi": "Región del Libertador Bernardo O'Higgins", "ohiggins": "Región del Libertador Bernardo O'Higgins", "libertador": "Región del Libertador Bernardo O'Higgins",
    # Maule
    "vii": "Región del Maule", "maule": "Región del Maule",
    # Ñuble
    "xvi": "Región de Ñuble", "nuble": "Región de Ñuble",
    # Bío-Bío
    "viii": "Región del Bío-Bío", "biobio": "Región del Bío-Bío",
    # Araucanía
    "ix": "Región de La Araucanía", "araucania": "Región de La Araucanía", "la_araucania": "Región de La Araucanía",
    # Los Ríos
    "xiv": "Región de Los Ríos", "los_rios": "Región de Los Ríos",
    # Los Lagos
    "x": "Región de Los Lagos", "los_lagos": "Región de Los Lagos",
    # Aysén
    "xi": "Región de Aysén del Gral.Ibañez del Campo", "aysen": "Región de Aysén del Gral.Ibañez del Campo",
    # Magallanes
    "xii": "Región de Magallanes y Antártica Chilena", "magallanes": "Región de Magallanes y Antártica Chilena", "antartica": "Región de Magallanes y Antártica Chilena"
}

provincia_names_chl: dict[str, str] = {
    # Norte
    "arica": "Arica",
    ...
    "petorca": "Petorca",
    "los_andes": "Los Andes",
    "san_felipe": "San Felipe", "san_felipe_de_aconcagua": "San Felipe",
    "quillota": "Quillota",
    "marga_marga": "Marga Marga",
    "valparaiso": "Valparaíso",
    "san_antonio": "San Antonio",
    "isla_de_pascua": "Isla de Pascua", "rapa_nui": "Isla de Pascua",
    "chacabuco": "Chacabuco",
    "santiago": "Santiago",
    ...
    "antartica_chilena": "Antártica Chilena", "antartica": "Antártica Chilena"
}

comuna_names_chl: dict[str, str] = {
    "algarrobo": "Algarrobo",
    "alhue": "Alhué",
    ...
    "yungay": "Yungay",
    "zapallar": "Zapallar",
    "zona_sin_demarcar": "Zona sin demarcar",
    "niquen": "Ñiquén",
    "nunoa": "Ñuñoa",
}
...
SCALE_MAPPINGS: dict[str, dict[str, str]] = {
    ...
    # Chile
    "region": region_names_chl,
    "provincia": provincia_names_chl,
    "comuna": comuna_names_chl,
}
...
SHAPEFILE_CONFIG: dict[str, tuple[str, str, str]] = {
    ...
    # Chile BCN
    "region":        ("boundaries_chl", "Regional.shp",   "Region"),
    "provincia":     ("boundaries_chl", "Provincias.shp", "Provincia"),
    "comuna":        ("boundaries_chl", "comunas.shp",    "Comuna"),
}
